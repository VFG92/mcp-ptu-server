...
**Version 5.0.3** | **LLM-Centric Parallel Reasoning, Capability-Driven, Industry-Aware, Persistent** | **For AI Agents & Developers**
...
**Version**: 5.0.3 (Session Persistence Fix)
...
- 8 Parallel Reasoning Tools (v5.0 - LLM-Centric Architecture)
...
- Latest deployment: 2025-10-01

**Recent Changes (v5.0.3)**:
- ✅ Fixed critical session persistence bug in Durable Objects
- ✅ Proper serialization/deserialization of nested Maps in session state
- ✅ "Session not found" error resolved for multi-step parallel reasoning workflows
